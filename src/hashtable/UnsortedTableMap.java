...
public class UnsortedTableMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
	...
	public void toTikz(String fname) throws IOException { return; }
	public String toTikzNode(Position<Entry<K, V>> node) { return null; }
